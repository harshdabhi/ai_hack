...
def create_medical_prompt():
    ...
    5. Be thorough and detailed in your response
    6. Include all relevant medical terminology
    7. Explain complex terms in simple language
    8. Provide specific recommendations when possible
    """)
...
def initialize_components():
    ...
    try:
        ...
        llm = Ollama(
            ...
            max_tokens=10000,  # Increased token limit for detailed responses
            top_p=0.9,  # Higher top_p for more diverse but relevant responses
            top_k=50,  # Higher top_k for better response quality
